...
class RationalesControllerTest < ActionController::TestCase
  ...
  test "should create rationale" do
    assert_difference('Rationale.count') do
      post :create, rationale: { concerns: @rationale.concerns, merits: @rationale.merits, position_id: @rationale.position_id, reasons: @rationale.reasons }
    end
  ...
  test "should update rationale" do
    patch :update, id: @rationale, rationale: { concerns: @rationale.concerns, merits: @rationale.merits, position_id: @rationale.position_id, reasons: @rationale.reasons }
    assert_redirected_to rationale_path(assigns(:rationale))
  end
